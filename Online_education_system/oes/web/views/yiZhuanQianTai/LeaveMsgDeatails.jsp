...
<div class="warp">
  ...
  <div class="listpage clearfix">
    <div class="lmenu">
      <h2>分类导航</h2>
      <ul class="menus">
        <li><a class="menulink active" href="#">留言信息</a></li>
    ...
    <div class="rcon">
       <c:if test="${comments==null}">
	      <div class="newscon">
	        ...
	        <div style="height:100%;width:98%;border:1px solid #F4F4F4;">
				<p class="breadcrumb" >留言人:${item.contentName}，时间:${item.ceateTime}</p>
				<p class="news-tit mt20" >标题:${item.c_title}</p>
				留言内容:<p style="text-indent:2em;" >${item.content}</p><br>
				
				<p style="">回复人:${item.rContentName}，回复时间:${item.rDateTime}</p>
				<p class="pmb30" style="" >回复内容:${item.rContent}</p>
	        </div>
	         </c:forEach>
	      </div>
        ...
        <c:if test="${comments!=null}">
	      <div class="newscon">
	        <div style="height:100%;width:98%;border:1px solid #F4F4F4;">
				<p class="breadcrumb" >留言人:${comments.contentName}，时间:${comments.ceateTime}</p>
				<p class="news-tit mt20" >标题:${comments.c_title}</p>
				留言内容:<p style="text-indent:2em;" >${comments.content}</p><br>
				
				<p style="">回复人:${comments.rContentName}，回复时间:${comments.rDateTime}</p>
				<p class="pmb30" style="" >回复内容:${comments.rContent}</p>
	        </div>
	      </div>
       </c:if>
    </div>
