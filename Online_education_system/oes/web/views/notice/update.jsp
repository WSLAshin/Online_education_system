...
<body>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">公告修改</a></li> 
  	</ul>
    </div> 
    ...
    <li><label>公告内容<b>*</b></label>
        <textarea rows="8" cols="86" name="notice_content" id="notice_content"  class="dfinput" style="width:518px;height:140px;">${notice.notice_content}</textarea>
    </li>
