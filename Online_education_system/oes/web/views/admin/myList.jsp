...
<body>
   ...
   <li><b style="color:red">${name}</b>，欢迎您登录</li>
    ...
    <ul class="forminfo">
    <li><label>管理员姓名<b>*</b></label><input name="name" id="name" type="text" class="dfinput" value="${item.name}" readonly="readonly"  style="width:518px;" /></li>
    <li><label>登陆名<b>*</b></label><input name="stu_name" id="stu_name" type="text" class="dfinput" value="${item.loginname}" readonly="readonly"  style="width:518px;"/></li>
    <li><label>管理员密码<b>*</b></label><input name="pwd" id="pwd" type="password" class="dfinput" value="${item.pwd}"  readonly="readonly" style="width:518px;"/></li>
    <li><label>级别<b>*</b></label><input name="adminLevel" id="adminLevel" type="text" class="dfinput" value="${item.adminLevel}"  readonly="readonly" style="width:518px;"/></li>
    <li style=""><label>&nbsp;</label><br>
	<form action="${ctx}/admin/findByteacher/${item.ad_id}" name="form" id="form" method="get">
	<input name="" type="submit" class="btn" value="去修改修改信息"/>
	</form>
    </li>
    </ul>
     </c:forEach>
