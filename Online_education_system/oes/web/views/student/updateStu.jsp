...
$(document).ready(function(e) {
   ...
   <script type="text/javascript">
    ...
    function validate(){
    	...
    	if(stu_name!=null&&stu_num!=null&&confirm_psw!=""&&phone!=""&&eamil!=""&&department!=""&&classT!=""){
    	   alert("修改信息成功！！！");	
    	   return true;
    	}
    }
...
<body>
   ...
   <li><b style="color:red"> ${name}</b>，欢迎您登录</li>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">学生信息修改</a></li> 
  	</ul>
    </div> 
  	<div id="tab1" class="tabson">
    <form  action="${ctx}/update" method="post"  onsubmit="return validate()">
	<input type="hidden" name="stu_id" value="${student.stu_id}" />
    <ul class="forminfo" style="float:left;">
    <li style="display:inline;">姓名<b>*</b><input  name="stu_name" id="stu_name" type="text" class="dfinput"style="width:200px;" value="${student.stu_name}" /></li>
    <li style="display:inline;">学号<b>*</b><input maxlength="11" name="stu_num" id="stu_num" type="text" class="dfinput"style="width:200px;" value="${student.stu_num}" /></li>
    <li style="display:inline;">性别<b>*</b>
        男<input name="gender" id="gender" type="radio" class="dfinput"style="width:30px;" value="男" ${student.gender eq'男'?'checked':''}  />
        女<input name="gender" id="gender" type="radio" class="dfinput"style="width:30px;" value="女" ${student.gender eq'女'?'checked':''} />
    </li></br></br>
    <li style="display:inline;">系别<b>*</b><input name="department" id="department" type="text" class="dfinput"style="width:200px;" value="${student.department}" /></li>
    <li style="display:inline;">班级<b>*</b><input name="classT" id="classT" type="text" class="dfinput"style="width:200px;" value="${student.classT}"/></li></br></br>
    ...
    <li >学生密码<b>*</b><input name="psw" id="psw" type="password" class="dfinput"style="width:200px;" value="${student.psw}"/></li>
